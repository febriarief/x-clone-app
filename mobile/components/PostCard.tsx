        ...
        <View className='flex-1'>
          ...
          <View className='flex-row justify-between max-w-xs'>
            <TouchableOpacity className='flex-row items-center' onPress={() => onComment(post)}>
              <Feather name='message-circle' size={18} color='#657785' />
            ...
            <TouchableOpacity className='flex-row items-center' onPress={() => {}}>
              <Feather name='repeat' size={18} color='#657785'/>
            ...
            <TouchableOpacity className='flex-row items-center' onPress={() => onLike(post._id)}>
              {isLiked ? (
                ...
                <Feather name='heart' size={18} color='#657785' />
              )}
            ...
            <TouchableOpacity className='flex-row items-center'>
              <Feather name='share' size={18} color='#657785'/>
            </TouchableOpacity>
          </View>
        </View>
      </View>
